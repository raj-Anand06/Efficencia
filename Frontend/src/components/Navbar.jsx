...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li><NavLink to="/efficiency" activeClassName="active">Efficiency</NavLink></li>
  ...
  return (
    <div className='max-w-screen-5xl md:w-full container mx-auto md:px-20 px-4'>
      <div className="navbar bg-base-100 w-full">
        <div className="navbar-start w-full">
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden mt-2">
        ...
        <div className="navbar-end md:w-full">
          <div className="hidden lg:flex">
            <ul className="menu font-semibold md:w-full menu-horizontal px-3 py-2 text-2xl">{navItems}</ul>
          </div>
        </div>
